...
Gist
 ...
 Watch 1
  Star 0
 Fork 44 twomice/civicrm-buildkit
forked from civicrm/civicrm-buildkit
 Code  Pull requests 0  Wiki  Pulse  Graphs
Branch: drupal8 Find file Copy pathcivicrm-buildkit/app/config/drupal8-demo/install.sh
cdf0840  13 hours ago
 Allen Shaw Using 'drush8' instead of 'drush' in drupal8-demo.
3 contributors @eileenmcnaughton @torrance @totten
RawBlameHistory     204 lines (178 sloc)  9.22 KB
#!/bin/bash
